...
let CreateCompanyUseCase = class CreateCompanyUseCase {
    ...
    async execute(name, description, type = company_type_enum_1.CompanyType.PYME) {
        const company = new company_1.Company(this.generateId(), name, type, description);
...
//# sourceMappingURL=create-company.usecase.js.map